...
> 2091-quest scenario-harness census (118 dropped quests excluded — 117 M2a + 6069 WI-6). **Band 1-10: 560 PASS / 0 SKIP / 0 FAIL = 100.0% PASS-or-doc-SKIP** of
...
> All SKIPs documented-SKIP with reason (12): 8 orphaned contexts (no quest_contexts row),
...
> carriers (6070/6075-6082) are sampled and PASS — 10/10 AbilityLevel contexts driven, 5967 (all-abilities branch)
> flipped SKIP→PASS, 6069 dropped 2026-08-09 (register §8, t_6810ebd4 — unreachable ltd, zero accept surfaces). Band-21-30 sweep calibration: kind_id-1 None components (legacy task-board
...
> unsampled carriers → 10/10 driven (108 cumulative, 6069 dropped not counted); zero PASS→SKIP regressions.
