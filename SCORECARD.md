...
| PACK-01 | Craft, carry, place, load, unload, sell trade pack | M4 | 1 | 1 | U | U | U | U | `SpecialtyManager`; pack audit; dossier `scorecard-explorations/mechanics/trade-packs.md` (canonical 1.2: craft 60 LP @ 특산품 제작대, backpack-slot occupancy, placed-pack doodad + 6-day expiry, 22 h mail payout — fork config 8 h, 80/20 seller/crafter split, gold/coin/star trader matrix, 70–130% dynamic ratio; `specialties` matrix loaded-unused; fork == upstream develop) |
