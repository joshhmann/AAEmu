...
| Physics warnings same-world | ≤ 5 in any 60s | no-sustained-slow clause: 6+ warnings on one world within 60s = thread cannot keep up (hard fail; ceiling 3-in-8s measured on the 2026-08-10 M6 6h re-soak → 5 ≈ 1.7× headroom) |
