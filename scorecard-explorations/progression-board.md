...
| **M5** | Gameplay Actor Contract | 🔶 **A1 + B1 COMPLETE — M5.1: Plant/PackPickup/PutDown/Buy-Sell + control-plane/MCP/consumer DONE; salvage + Phase-2 prereqs + M5.2 Housing.Build OPEN (2026-08-13)** — A1 marshal seam (c6d8f93a0) + B1 core action surface (Interact · Loot · UseItem · Mount/Dismount · AcceptQuest · TurnInQuest through real engine paths; merged 761d1e81a; Rei gates t_d06d8dd9/t_ebfc9b35; merged-tree re-verify 1850/0/1). M5.1 DONE: Plant (t_b1d7c430, supersedes t_a69e4998) · PackPickup/PutDown (t_64ecf525, Rei t_9ca4aa07) · Buy/Sell (t_8741b03d) · control plane (t_7b6d7a4b, Rei t_29d2273b) · MCP sidecar (t_446228b5, Rei t_b5467288) · first consumer Lane D (t_52b2b084, Rei t_0e01ef42). **SALVAGE wave — serial merge, no re-implementation (Kimi memo 2026-08-13):** Deposit/Withdraw t_78ce17a2 (blocked) → Harvest t_234da01a → BoardVehicle t_15343fdd → Craft split t_6b5ac43e (rig) + t_cffb71ad (impl). **Phase-2 prerequisites (blocked; previously in no card's scope):** LoadPackOntoVehicle t_a7756a00, DriveVehicle t_eaf1754d. **M5.2 Housing.Build t_94761d55 (running)** — Josh-approved Phase-2 scope (t_2625be99), impl OPEN. Phase 1 t_61a0eebb **BLOCKED** (min-slice only; follow-up t_15787275); Phase 2 root t_b4f455b0 todo; human packet t_2b654349 todo; threading-boundary + M5 core exit test open. **UPDATE 2026-08-14 (scope marker t_2625be99):** salvage wave COMPLETE (Deposit/Withdraw 78ce17a2 · Harvest 234da01a · BoardVehicle 15343fdd · Craft rig+impl 6b5ac43e/cffb71ad — all merged); Phase-2 prerequisites MERGED (LoadPackOntoVehicle t_a7756a00 @ 6c2429ae0, DriveVehicle t_eaf1754d @ 6edbf0cbb); **M5.2 Housing.Build t_94761d55 DONE @ 3396d9ef1 (Rei t_ebf36737 ACCEPT)** — replay route locked **Housing.Build → farm/storage → craft → pack → load/drive vehicle → unload → sell → reward**; Phase 2 root t_b4f455b0 **dispatched** (conservation + restart evidence + traces; H stays UNKNOWN) |
...
- **M5 A1 + B1 landed on develop** — A1 marshal seam + B1 six-action contract surface through real engine paths (c6d8f93a0 / 761d1e81a); M5.1: Plant/PackPickup/PutDown/Buy-Sell + control-plane/MCP/consumer DONE — salvage wave (Deposit/Withdraw → Harvest → BoardVehicle → Craft split) + Phase-2 vehicle prerequisites + M5.2 Housing.Build open.
- **M5.1 recovery plan canon (2026-08-13, t_c9f0d7f6)** — Kimi memo + Codex reconciliation: salvage+serial-merge order recorded (work preserved in workspaces, no re-implementation); LoadPackOntoVehicle (t_a7756a00) + DriveVehicle (t_eaf1754d) recorded as genuine Phase-2 prerequisites; Housing.Build = M5.2 contract card (t_94761d55) in Josh-approved Phase-2 scope, impl OPEN; Phase 1 stays open (live route evidence is min-slice only — follow-up t_15787275); prior shortcut rigs superseded for authentic acceptance, NOT erased; H stays UNKNOWN.
- **Bot-backtrack program Phases 0.1–0.3 complete (2026-08-12)** — 7-state milestone evidence ledger (t_547ef82d), H grades reconciled (proxy ≠ H=2; H stays U), 5 deferred validation gates explicit (t_4ec066d3), M6 B4 restart-persistence replay PASS (t_9340e85d); soak verdict + history preserved verbatim; **Phases 1 (M1/M2 replay, t_61a0eebb — BLOCKED/open, min-slice evidence only; follow-up t_15787275) + 2 (M3a/M4 economic replay, t_b4f455b0) queued behind M5.1 salvage + vehicle prerequisites (t_a7756a00 LoadPackOntoVehicle / t_eaf1754d DriveVehicle); Housing.Build rides Phase 2 as M5.2 (t_94761d55, Josh-approved scope, impl open)**.
