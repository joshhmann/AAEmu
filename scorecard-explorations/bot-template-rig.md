...
> Curated snapshot (committed 2026-08-12): the LIVE evidence table is
> regenerated by BotScenarioRigTests to
> `scorecard-explorations/generated/bot-template-rig.md` on every gate run
> (gitignored). Section order there follows TUnit execution order and varies
> by run context; this committed snapshot is one canonical capture.
