...
- Current evidence:
  ...
  4. **Rig & Gate Evidence**: `LevelingLoopScenarioRigTests` **40/40** green (+2 tests). Full `./scripts/gate.sh` passed with 0 compiler errors/warnings, in-game script compilation succeeded, **2,783 total tests (2,782 passed, 1 skipped)**, MCP BotControl 39 tools, MCP Archaeology 24 tools.
