...
<body>
    ...
    <div class="top-nav">
        <div class="top-nav-inner">
            ...
            <button class="nav-tab-btn" id="tabBtn-milestones" onclick="switchMainTab('milestones')">🎯 Roadmap & Scorecard (M1–M10) <span class="tab-badge">75%</span></button>
    ...
    <div class="container">
        ...
        <!-- ==================== TAB 2: MILESTONES & SCORECARD ==================== -->
        <div class="tab-pane" id="tabPane-milestones">
            <div class="summary-banner">
                <div class="banner-stat">
                    <h3>75% Complete</h3>
                    <p>Overall Roadmap Progress (M1–M10)</p>
                </div>
                <div class="banner-stat">
                    <h3>6 Closed</h3>
                    <p>M1, M2, M3a/b, M4, M5, M6</p>
                </div>
                <div class="banner-stat">
                    <h3>2 Active</h3>
                    <p>M7 Adventurer, M8 Living World</p>
                </div>
                <div class="banner-stat">
                    <h3>2 Queued</h3>
                    <p>M9 Dominion Siege, M10 High Seas</p>
                </div>
            </div>
            <div class="info-card vision-card" style="margin-bottom: 20px; border-left: 4px solid var(--purple);">
                ...
                <div class="task-desc">AAEmu bots must grind, farm, trade, sail, and siege through <strong>real engine paths</strong> (never parallel gameplay systems — Lane B composes around ordinary Character records per AGENTS.md rules #9/#10), while human traces supply the ground-truth packet telemetry that proves each slice. Scorecard per milestone: <strong>A</strong> = automated evidence (gate/soak PASS), <strong>H</strong> = Josh-only human-feel verdict; a milestone is not done until both are recorded.</div>
                <div class="meta-row"><span>Exit bar (every milestone)</span><span class="meta-val">Gate green + soak green + A evidence linked + H verdict (or explicit H=UNKNOWN)</span></div>
                <div class="meta-row"><span>Current frontier</span><span class="meta-val">M7 party play → M8 convoys/auction → M9 siege → M10 naval</span></div>
            </div>
            ...
            <div class="milestone-grid">
                ...
                <div class="info-card">
                    ...
                    <div class="meta-row"><span>Automated Evidence</span><span class="meta-val">A=2 (Live engine release 94f498fc)</span></div>
                    <div class="meta-row"><span>Human Feel (H)</span><span class="meta-val" style="color: var(--yellow)">H=UNKNOWN (Pending Josh verdict)</span></div>
                    <div class="meta-row"><span>Key Assets</span><span class="meta-val">Solzreed golden route, Quest 250</span></div>
                </div>
                ...
                <div class="info-card">
                    ...
                    <div class="task-desc">Every live context PASS or registered-drop or doc-SKIP across 4,579 quests with zero unexplained failures.</div>
                    <div class="meta-row"><span>Automated Evidence</span><span class="meta-val">A=2 (G1 Gate Passed 2026-08-10)</span></div>
                    <div class="meta-row"><span>Total Census Quests</span><span class="meta-val">4,573 PASS / 14 doc-SKIP / 0 FAIL</span></div>
                    <div class="meta-row"><span>Human Feel (H)</span><span class="meta-val" style="color: var(--yellow)">H=UNKNOWN (Two-player baseline)</span></div>
                </div>
                ...
                <div class="info-card">
                    ...
                    <div class="meta-row"><span>Crash Hardness</span><span class="meta-val">kill -9 asserted mid-save (p95 1301ms)</span></div>
                    <div class="meta-row"><span>Tables Wired</span><span class="meta-val">9/9 core housing tables wired (100%)</span></div>
                    <div class="meta-row"><span>Human Feel (H)</span><span class="meta-val" style="color: var(--yellow)">H=UNKNOWN (Homestead feel)</span></div>
                </div>
                ...
                <div class="info-card">
                    ...
                    <div class="task-desc">Harvest crops, craft trade packs, load cargo onto vehicle, drive 3-leg trade routes, and sell to gold traders.</div>
                    <div class="meta-row"><span>Deployment</span><span class="meta-val">Live deployed on CT 133 (.165)</span></div>
                    <div class="meta-row"><span>Automated Evidence</span><span class="meta-val">M4ExitIntegratedSessionTests PASS</span></div>
                    <div class="meta-row"><span>Human Feel (H)</span><span class="meta-val" style="color: var(--yellow)">H=UNKNOWN (Economic replay)</span></div>
                </div>
                ...
                <div class="info-card">
                    ...
                    <div class="meta-row"><span>Core Actions</span><span class="meta-val">100% wired through real engine paths</span></div>
                    <div class="meta-row"><span>Fast Gate</span><span class="meta-val">3,214 passed / 0 failed</span></div>
                    <div class="meta-row"><span>Rei Gate Verdict</span><span class="meta-val">ACCEPT (Zero engine-file drift)</span></div>
                </div>
                ...
                <div class="info-card">
                    ...
                    <div class="task-desc">Durable bots across server reboots, coordinate preservation, roll/yaw SQL fix, /bot restore, and 10-bot 6-hour green soak.</div>
                    <div class="meta-row"><span>Reboot Persistence</span><span class="meta-val">PB-006 CLOSED (Full state retention)</span></div>
                    <div class="meta-row"><span>Commands</span><span class="meta-val">/bot add, /bot restore, /bot here</span></div>
                    <div class="meta-row"><span>Living World Scale</span><span class="meta-val">1,000-citizen soak queued</span></div>
                </div>
                ...
                <div class="info-card">
                    ...
                    <div class="task-desc">Autonomous mob grinding, combat rotations, sustain retreats, corpse looting, equip upgrades, and party formation.</div>
                    <div class="meta-row"><span>Solo Adventurer</span><span class="meta-val">100% Complete (Quest 250→330 loop)</span></div>
                    <div class="meta-row"><span>Combat Trees</span><span class="meta-val">Battlerage, Shadowplay, Archery, Sorcery, Defense</span></div>
                    <div class="meta-row"><span>Next Slice</span><span class="meta-val">Party follow-leader & assist targeting</span></div>
                    <div class="meta-row"><span>Exit Criteria</span><span class="meta-val">Party assist targeting + follow-leader soak green + H party-play verdict</span></div>
                </div>
                ...
                <div class="info-card">
                    ...
                    <div class="task-desc">Autonomous bot farming, specialty crafting, cross-zone cart convoys, merchant restock, and auction house trading.</div>
                    <div class="meta-row"><span>Working Core</span><span class="meta-val">Farming loop, direct merchant trading</span></div>
                    <div class="meta-row"><span>Next Slice</span><span class="meta-val">Trade pack convoys & auction bots</span></div>
                    <div class="meta-row"><span>Revisit Trigger</span><span class="meta-val">M7 Party spike completion</span></div>
                ...
                <div class="info-card">
                    ...
                    <div class="task-desc">Auroria territory claims, castle building, siege battle timers, tank/trebuchet war machines, and wall destruction.</div>
                    <div class="meta-row"><span>Working Core</span><span class="meta-val">DominionManager + 3 siege tables wired</span></div>
                    <div class="meta-row"><span>Missing Slice</span><span class="meta-val">Full siege warfare combat & destructibility</span></div>
                    <div class="meta-row"><span>Target Zones</span><span class="meta-val">Nuimari, Heedmar, Marcala, Calmlands</span></div>
                    <div class="meta-row"><span>Exit Criteria</span><span class="meta-val">Timed siege battle + wall destruction + H siege verdict</span></div>
                </div>
                ...
                <div class="info-card">
                    ...
                    <div class="meta-row"><span>Working Core</span><span class="meta-val">VehicleMovementModel, cargo snapping</span></div>
                    <div class="meta-row"><span>Missing Slice</span><span class="meta-val">Ship cannon ballistics, ocean trade runs</span></div>
                    <div class="meta-row"><span>Target Zones</span><span class="meta-val">Arcadian Sea, Castaway Strait, Freedich</span></div>
