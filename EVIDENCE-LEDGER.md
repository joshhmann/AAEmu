...
| **M1** Quest/progression spine (CLOSED, automated evidence) | ✅ | ✅ prod release @ 94f498fc (08-04) | ✅ exit-test harness | ✅ 153/153 runnable, 0 FAIL, 33 SKIP / 186 quests; gate 1148/1148 · ✅ control-plane contract replay 16/16 quests, contract actions only (t_61a0eebb, 2026-08-13, proxy) | ✅ retroactive via M2 baseline t_cca63225 + live probe t_92a41fe6 2/2 | — | ⏳ DEFERRED — playtest verdict open (Open Decision #1, C5) · H UNKNOWN |
| **M2** Golden-path baseline (DONE, G1 gate PASSED 08-10) | ✅ @ 7f5c179f7 | — (no separate deploy record) | ✅ census harness + M2b-E2E | ✅ 4,573 PASS / 0 FAIL / 14 doc-SKIP; full gate 1495/0/1; M2b pilot 30/30 · ✅ control-plane contract replay 16/16 quests incl. mount chain, contract actions only (t_61a0eebb, 2026-08-13, proxy) | ✅ automated t_c6eb12ec/t_1998cfd8, restart t_cca63225/t_c069bacd + probe t_92a41fe6, clean-host t_52755daa/t_819930ef | — | ⏳ DEFERRED to M4 close (t_46bf9b84) · H UNKNOWN |
...
- **M1:** ROADMAP §M1 status (2026-08-04→08-05, reconciled 08-11); STATUS M1;
  ...
  control-plane contract replay t_61a0eebb (2026-08-13, 16/16 quests, proxy).
- **M2:** ROADMAP §M2 (redefined 08-10 audit); STATUS M2; G1 gate @ 7f5c179f7
  ...
  control-plane contract replay t_61a0eebb (2026-08-13, 16/16 incl. mount chain, proxy).
...
- 2026-08-13 — BACKTRACK Phase 1 (t_61a0eebb): M1/M2 contract replay via the
  ...
  Proxy/bot-functional evidence (rig + live E2E); H stays UNKNOWN — no
  scripted evidence recorded as H=2. Ledger rows M1/M2 advanced in the
  bot-replay-passed cell with the replay citation; prior evidence untouched.
