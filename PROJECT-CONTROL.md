...
- **Target:** ArcheAge 1.2 client and reference data `compact.sqlite3` r208022
  (read-only)
**Audited source/evidence baseline:** `da0fdc61a72a15111fddc8ac627a164a5f050558`
(`develop`, local source/test HEAD; M5 proposal `263ecc66c474ca1c5f4b085e86ef3e47f49fd1`,
M6 cancellation `950cfd279`, population isolation `c97909f4f`, and opt-in
six-hour leg `155c82c66` are in its ancestry).
